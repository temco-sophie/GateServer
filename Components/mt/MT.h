...
#define MT_UTIL_ZCL_KEY_ESTABLISH_IND        0xE1
  ...
  #define MT_UTIL_GET_MICRO_TIME                0x12
  #define MT_UTIL_SET_MICRO_TIME                0x13
#endif
  
#if defined ( GATE_PROTOCAL)
  #define MT_UTIL_GATE_PROTOCAL_CMD               0x14
  #define MT_UTIL_SEND_CMD_WITH_ADDR              0x15
  #if defined ( JUMP_MACHINE)
    #define MT_UTIL_CONFIRM_RFID_RSP                0x16
  #endif
#endif
  
#define MT_UTIL_READ_SD                       0x26
/***************************************************************************************************
 * DEBUG COMMANDS
 ***************************************************************************************************/
